...
export default function ActiveTasks() {
  ...
  const tasks = useQuery(api.task.getByStatus, { status: "active" });
  ...
  const toggleStatus = (id: any, isCompleted: boolean) => {
    updateStatus({ id, isCompleted: !isCompleted });
  };
        ...
        >
          <View style={styles.content}>
            ...
            <View style={styles.taskList}>
              ...
              {tasks?.map((task: { _id: string; text: string; isCompleted: boolean }) => (
                <View key={task._id} style={styles.taskItem}>
                  <TouchableOpacity
                    style={styles.radioButton}
                    onPress={() => toggleStatus(task._id, task.isCompleted)}
                  >
                    <View style={[styles.radioCircle, task.isCompleted && styles.radioSelected]}>
                      {task.isCompleted && <View style={styles.radioInner} />}
                    </View>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity style={styles.deleteButton} onPress={() => deleteTask(task._id)}>
